...
<div class="col-sm-4 research-media research-media-logo{% if experience.logo_size %} research-media-logo-{{ experience.logo_size }}{% endif %}">
{% if experience.image %}
  <img src="{{ site.url }}{{ site.baseurl }}/images/{{ experience.image }}" style="display:block;"/>
{% endif %}
</div>
